import { capturar_usuario_logado, capturar_dados_usuario, capturar_candidatos,cadastrar_vaga,capturar_vagas,  retornar_quantidade_candidatos ,remover_empresa, } from "./localStorageControler";
