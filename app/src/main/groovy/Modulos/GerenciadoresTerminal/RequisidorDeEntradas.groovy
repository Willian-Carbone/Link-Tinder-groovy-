...
import GerenciadoresDeBanco.CurtidorI
...
class RequisidorDeEntradas {
    ...
    static void solicitarRespostaRemocaoPerfil(String identificador, Scanner scan, CrudPerfilPrincipal gerenciador){
        ...
        if (checkDelet == identificador) {
           gerenciador.removerPerfil(identificador)
