...
import View.Impressores.ExibicaoCandidatosQueCurtiramVaga
import View.Impressores.ExibicaoMatchEmpresa
import View.Impressores.ExibicaoVagasEmpresa
...
import View.Impressores.Impressor
        ...
        while (opcaoSelecionada != "8") {
            ...
            switch (opcaoSelecionada) {
                ...
                case "7":
                    ...
                    if(RequisidorDeEntradas.solicitarRespostaRemocaoPerfil(cnpj,scan)){
                        gerenciadorEmpresa.removerPerfil(cnpj)
                        System.exit(0)
                    }
