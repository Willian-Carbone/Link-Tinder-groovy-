...
import View.Impressores.ExibicaoMatchCandidato
import View.Impressores.ExibicaoVagasCandidato
        ...
        while (opcaoSelecionada != "6") {
            ...
            switch (opcaoSelecionada) {
                ...
                case "4":
                    ...
                    if(RequisidorDeEntradas.solicitarRespostaRemocaoPerfil(cpf,scan)){
                        gerenciadorCandidato.removerPerfil(cpf)
                        System.exit(0)
                    }
